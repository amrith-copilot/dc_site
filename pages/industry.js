...
const Industry = () => {
    ...
    return (
        <>
            <Head>
                <title>DATACLAP DIGITALDIGITAL</title>
            </Head>
                        ...
                        <div className="box-create-account">
                            <div className="row align-items-center">
                                <div className="col-lg-6 position-relative mb-30">
                                    <div className="box-image-account"><img className="d-block" src="assets/imgs/page/homepage3/img4.png" alt="DATACLAP DIGITALDIGITAL" /></div>
                                </div>
